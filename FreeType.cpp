...
void Font::make_dlist( FT_Face face, char ch) {
	...
	col[0] = color.r; col[1] = color.g; col[2] = color.b; //r,g,b values for each vertex
	col[3] = color.r; col[4] = color.g; col[5] = color.b;
	col[6] = color.r; col[7] = color.g; col[8] = color.b;
	col[9] = color.r; col[10] = color.g; col[11] = color.b;
	col[12] = color.r; col[13] = color.g; col[14] = color.b;
	col[15] = color.r; col[16] = color.g; col[17] = color.b;
...
void Font::init(const char * fname, unsigned int h, glm::vec4 col) {
	color = col;
	Font::loadShader("shaders/basicTexture3");
...
///with freetype fonts.
void Font::print(glm::mat4 &ProjectionMatrix, Font &ft_font, float x, float y, const char *fmt, ...)  {
	...
	glUniform4f(glGetUniformLocation(Font::myShader->handle(), "ex_Color"), color.x, color.y, color.z, color.a);
